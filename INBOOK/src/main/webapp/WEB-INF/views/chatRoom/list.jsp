						...
						<div style="padding: 0px 0px 0px 90px;">
							<div class="input-group">
								...
								<div class="input-group-btn">
									<button class="btn btn-default" type="button" style="font-size: 12pt;" id="chatRoomWriteBtn">생성</button>
									<button class="btn btn-default" type="button" style="font-size: 12pt;" id="chatRoomUpdateBtn">수정</button>
									<br>
									<button class="btn btn-default" type="button" style="font-size: 12pt;" id="cancelChatRoomUpdateBtn">취소</button>
			...
			<div style="padding: 100px 500px 0px 0px;">
				<div id="tabs-1">
					<div class="list-group">
								...
								<div class="list-group-item">
									...
									<c:if test="${!empty login && login.id == chatRoomVo.id  || login.gradeNo == 9 }">
										<span class="pull-right">
											<button class="chatRoomUpdateBtn btn btn-default btn-xs" data-cno="${chatRoomVo.cno }">수정</button>
											<button class="chatRoomDeleteBtn btn btn-default btn-xs" data-cno="${chatRoomVo.cno }">삭제</button>
										</span>
									</c:if>
						...
						<c:if test="${empty list }">
							<div class="list-group-item">데이터가 존재하지 않습니다.</div>
						</c:if>
					</div>
				</div>
			</div>
